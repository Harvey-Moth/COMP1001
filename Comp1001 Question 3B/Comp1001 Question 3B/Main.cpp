...
#define IN "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\input_images"
#define OUT "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\output_images"
#define OUT2 "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\output_images"
...
int main() {
	...
	for (j = 0; j < 31; j++)
	{
		...
		char file_name[100];
		sprintf_s(file_name, "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\input_images\\a%i.pgm", j); //This is allowing us to concatenate the string that points to the file with an incrementing value so we can loop through all the files.

		char file_output1[100];
		sprintf_s(file_output1, "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\output_images\\blurred%i.pgm", j); 
		char file_output2[100];																														//This is doing the same as above but for the output
		sprintf_s(file_output2, "C:\\Users\\mothy\\Documents\\GitHub\\COMP1001\\Comp1001 Question 3B\\output_images\\edge_detection%i.pgm", j);
		read_image(file_name);//read image from disc

		
		Gaussian_Blur(); //blur the image (reduce noise)
		Sobel(); //apply edge detection

		write_image2(file_output1, filt); //store output image to the disc
		write_image2(file_output2, gradient); //store output image to the disc
